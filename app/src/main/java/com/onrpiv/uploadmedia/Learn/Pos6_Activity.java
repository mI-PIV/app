...
public class Pos6_Activity extends FluidGlossary {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t1.setText("A wake is a region of flow downstream of a solid body moving through a fluid, caused by the flow of the fluid around the body. A common observation of a wake is the path left by a bird moving in calm water or the flow moving behind a ball flying through the air, as shown here:");
