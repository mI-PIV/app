...
public class Pos14_Activity extends FluidGlossary {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String html1 = "<u><b>Inviscid</b></u>: An inviscid flow assumes that the effects of viscosity are negligible. In high Reynolds number flows such as over an aircraft wing, this assumption results in small error, and allows for simplification of many physical laws.<br>";
