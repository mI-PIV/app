...
public class FrameView extends FrameLayout {
    ...
    public FrameView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
                ...
                if (l < 30.0f) {
                    ...
                    if (System.currentTimeMillis() - lastTapTime < 250) {
                        ...
                        if (null != positionCallback) {
                            positionCallback.getSelectPosition(zoomX + (x - 0.5f * getWidth()) / zoom, zoomY
