...
import static com.onrpiv.uploadmedia.Utilities.ColorMap.ColorMapUtils.dip2px;
import static com.onrpiv.uploadmedia.Utilities.ColorMap.ColorMapUtils.getDimensionDp;
...
public class ColorMapPicker {
    ...
    public interface OnChooseColorListener {
        void onChooseColor(int position, Drawable color);

        void onCancel();
    }

    public interface OnFastChooseColorListener {
        void setOnFastChooseColorListener(int position, Drawable color);

        void onCancel();
    }

    public interface OnButtonListener {
        void onClick(View v, int position, Drawable color);
    }

    private ArrayList<ColorMapPal> colors;
    private ColormapViewAdapter colorViewAdapter;
    ...
    private Drawable default_color;
     ...
     * Constructor
     */
    public ColorMapPicker(Activity context) {
        ...
        this.default_color = context.getResources().obtainTypedArray(R.array.colormaps).getDrawable(0);
        this.columns = 5;
    }
...
//            colors.add(new ColorMapPal(ta.getColor(i, 0), false));
//        }
//        return this;
//    }
...
//            colors.add(new ColorMapPal(Color.parseColor(colorsHexList.get(i)), false));
//        }
//        return this;
//    }
...
//            colors.add(new ColorMapPal(aColorsList, false));
//        }
//        return this;
//    }

    public ColorMapPicker setColors(ArrayList<Drawable> drawables) {
        colors = new ArrayList<>();
        for (Drawable aDrawable : drawables) {
            colors.add(new ColorMapPal(aDrawable, false));
        }
        return this;
    }
     ...
     * @return this
     */
    public ColorMapPicker setDefaultColorButton(Drawable color) {
    ...
    public void show() {
        ...
        if (fastChooser)
            colorViewAdapter = new ColormapViewAdapter(colors, onFastChooseColorListener, mDialog);
        else
            colorViewAdapter = new ColormapViewAdapter(colors);
     ...
     * @return this
     */
    public ColorMapPicker setColumns(int c) {
        columns = c;
        return this;
    }
     ...
     * @return this
     */
    public ColorMapPicker setTitle(String title) {
        this.title = title;
        return this;
    }
     ...
     * @return this
     */
    public ColorMapPicker setColorButtonTickColor(int color) {
     ...
     * @return this
     */
    public ColorMapPicker setColorButtonDrawable(int drawable) {
     ...
     * @return this
     */
    public ColorMapPicker setColorButtonSize(int width, int height) {
     ...
     * @return this
     */
    public ColorMapPicker setColorButtonMargin(int left, int top, int right, int bottom) {
     ...
     * @return this
     */
    public ColorMapPicker setRoundColorButton(boolean roundButton) {
     ...
     * @return this
     */
    public ColorMapPicker setOnFastChooseColorListener(OnFastChooseColorListener listener) {
     ...
     */
    public ColorMapPicker setOnChooseColorListener(OnChooseColorListener listener) {
     ...
     * @return this
     */
    public ColorMapPicker addListenerButton(String text, Button button, final OnButtonListener listener) {
     ...
     * @return this
     */
    public ColorMapPicker addListenerButton(String text, final OnButtonListener listener) {
        if (mContext == null)
            return this;
     ...
     * @return this
     */
    public ColorMapPicker setDismissOnButtonListenerClick(boolean dismiss) {
     ...
     * @return this
     */
    public ColorMapPicker setDialogFullHeight() {
     ...
     * @return this
     */
    public ColorMapPicker disableDefaultButtons(boolean disableDefaultButtons) {
     ...
     * @return this
     */
    public ColorMapPicker setTitlePadding(int left, int top, int right, int bottom) {
     ...
     * @return this
     */
    private ColorMapPicker setColors() {
        if (mContext == null)
            return this;
        ...
        ta = context.getResources().obtainTypedArray(R.array.colormaps);
        colors = new ArrayList<>();
        for (int i = 0; i < ta.length(); i++) {
            colors.add(new ColorMapPal(ta.getDrawable(i), false));
        }
        return this;
    }

    private ColorMapPicker setMargin(int left, int top, int right, int bottom) {
